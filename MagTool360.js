  ...
  const MagControls = () => {
    ...
    this.css = ({
      ...
      "frameCSS": {
        ...
        "top":            `${event.pageY - (this.data.frameSize / 2)}px`,
        "left":           `${event.pageX - (this.data.frameSize / 2)}px`,
        "background":     "white",
      ...
      "frameContentCSS": {
        ...
        "left":             `${(event.pageX - (this.data.dimension()/2) * this.data.magnification * -1)}px`,
        "top":              `${(event.pageY - (this.data.dimension()/2) * this.data.magnification * -1)}px`,
        "cursor":           "default",
        "pointer-events":   "none"
      }
    });
    ...
    this.privateMethods = ({
      ...
      positionFrame: () => {
        this.privateMethods.updateMouseData();
